$(document.body).on('mouseenter', '.code-link' ,function(event){
  $('.codePage-pop').addClass('a-fadeoutT');
  $('.codePage-pop').show();
});
$(document.body).on('mouseleave', '.code-line' ,function(event){
  $('.codePage-pop').removeClass('a-fadeoutT');
  $('.codePage-pop').hide();
});
